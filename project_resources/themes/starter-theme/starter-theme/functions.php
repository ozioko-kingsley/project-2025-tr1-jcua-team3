...
/**
 * To use testimonial as a shortcode "[baizonn_testimonials]"
 */
function baizonn_testimonials_shortcode()
{
    ob_start();
?>
...
add_shortcode('baizonn_testimonials', 'baizonn_testimonials_shortcode');
